...
public class ExpressionEdgeCaseIntegrationTests : IntegrationTestBase
{
	...
	[Theory]
	[InlineData("EXTRACT(HOUR FROM TIMESTAMP '2024-01-15T14:30:00Z')", 14L)]
	...
	[InlineData("EXTRACT(YEAR FROM TIMESTAMP '2024-01-15T00:00:00Z')", 2024L)]
	[InlineData("EXTRACT(MONTH FROM TIMESTAMP '2024-06-15T00:00:00Z')", 6L)]
	[InlineData("EXTRACT(DAY FROM TIMESTAMP '2024-01-31T00:00:00Z')", 31L)]
	...
	[Theory]
	[InlineData("EXTRACT(DAY FROM TIMESTAMP_ADD(TIMESTAMP '2024-01-15T00:00:00Z', INTERVAL 1 DAY))", 16L)]
	[InlineData("EXTRACT(DAY FROM TIMESTAMP_ADD(TIMESTAMP '2024-01-31T00:00:00Z', INTERVAL 1 DAY))", 1L)]
	[InlineData("EXTRACT(MONTH FROM TIMESTAMP_ADD(TIMESTAMP '2024-01-31T00:00:00Z', INTERVAL 1 DAY))", 2L)]
	[InlineData("EXTRACT(HOUR FROM TIMESTAMP_ADD(TIMESTAMP '2024-01-15T23:00:00Z', INTERVAL 2 HOUR))", 1L)]
	[InlineData("EXTRACT(DAY FROM TIMESTAMP_SUB(TIMESTAMP '2024-01-15T00:00:00Z', INTERVAL 1 DAY))", 14L)]
	[InlineData("EXTRACT(DAY FROM TIMESTAMP_SUB(TIMESTAMP '2024-03-01T00:00:00Z', INTERVAL 1 DAY))", 29L)]
	[InlineData("EXTRACT(MONTH FROM TIMESTAMP_SUB(TIMESTAMP '2024-01-01T00:00:00Z', INTERVAL 1 DAY))", 12L)]
	[InlineData("EXTRACT(YEAR FROM TIMESTAMP_SUB(TIMESTAMP '2024-01-01T00:00:00Z', INTERVAL 1 DAY))", 2023L)]
