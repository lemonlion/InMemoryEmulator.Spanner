...
Instead, please create a [private GitHub security advisory](https://github.com/lemonlion/Spanner.InMemoryEmulator/security/advisories/new) with the following information:
...
This security policy applies to the latest released version of the `Spanner.InMemoryEmulator` NuGet package.
